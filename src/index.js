...
InstantMeiliSearch.prototype.meiliSearchInputForSearch = function(params) {
  const searchInput = {
    q: params.query,
    facetsDistribution:
...
InstantMeiliSearch.prototype.parseHighlight = function(formattedHit, params) {
...
InstantMeiliSearch.prototype.parseHits = function(meiliSearchHits, params) {
...
InstantMeiliSearch.prototype.paginationParams = function(hitsLength, params) {
  if (params.page !== undefined) {
...
InstantMeiliSearch.prototype.parseMeiliSearchResponse = function(indexUid, meiliSearchResponse, params) {
...
InstantMeiliSearch.prototype.search = async function(requests) {
